...
/* package secureUrl-0.1.0.0 */
#ifndef VERSION_secureUrl
#define VERSION_secureUrl "0.1.0.0"
#endif /* VERSION_secureUrl */
#ifndef MIN_VERSION_secureUrl
#define MIN_VERSION_secureUrl(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_secureUrl */
...
/* package persistent-2.14.3.0 */
#ifndef VERSION_persistent
#define VERSION_persistent "2.14.3.0"
...
#define CURRENT_COMPONENT_ID "secureUrl-0.1.0.0-inplace-secureUrl"
